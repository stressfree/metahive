...
privileged aspect DataSourceIntegrationTest_Roo_IntegrationTest {
    ...
    public void DataSourceIntegrationTest.testCountDataSources() {
        ...
        long count = net.triptech.metahive.model.DataSource.countDataSources();
    ...
    public void DataSourceIntegrationTest.testFindDataSource() {
        net.triptech.metahive.model.DataSource obj = dod.getRandomDataSource();
        ...
        obj = net.triptech.metahive.model.DataSource.findDataSource(id);
    ...
    public void DataSourceIntegrationTest.testFindAllDataSources() {
        ...
        java.util.List<net.triptech.metahive.model.DataSource> result = net.triptech.metahive.model.DataSource.findAllDataSources();
    ...
    public void DataSourceIntegrationTest.testFindDataSourceEntries() {
        ...
        java.util.List<net.triptech.metahive.model.DataSource> result = net.triptech.metahive.model.DataSource.findDataSourceEntries(0, (int) count);
    ...
    public void DataSourceIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyDataSource(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        net.triptech.metahive.model.DataSource merged =  obj.merge();
        obj.flush();
    ...
    public void DataSourceIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'DataSource' failed to initialize correctly", dod.getRandomDataSource());
        net.triptech.metahive.model.DataSource obj = dod.getNewTransientDataSource(Integer.MAX_VALUE);
    ...
    public void DataSourceIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'DataSource' with identifier '" + id + "'", net.triptech.metahive.model.DataSource.findDataSource(id));
    }

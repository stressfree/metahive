...
privileged aspect CategoryIntegrationTest_Roo_IntegrationTest {
    ...
    public void CategoryIntegrationTest.testCountCategorys() {
        ...
        long count = net.triptech.metahive.model.Category.countCategorys();
    ...
    public void CategoryIntegrationTest.testFindCategory() {
        net.triptech.metahive.model.Category obj = dod.getRandomCategory();
        ...
        obj = net.triptech.metahive.model.Category.findCategory(id);
    ...
    public void CategoryIntegrationTest.testFindAllCategorys() {
        ...
        java.util.List<net.triptech.metahive.model.Category> result = net.triptech.metahive.model.Category.findAllCategorys();
    ...
    public void CategoryIntegrationTest.testFindCategoryEntries() {
        ...
        java.util.List<net.triptech.metahive.model.Category> result = net.triptech.metahive.model.Category.findCategoryEntries(0, (int) count);
    ...
    public void CategoryIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyCategory(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        net.triptech.metahive.model.Category merged =  obj.merge();
        obj.flush();
    ...
    public void CategoryIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Category' failed to initialize correctly", dod.getRandomCategory());
        net.triptech.metahive.model.Category obj = dod.getNewTransientCategory(Integer.MAX_VALUE);
    ...
    public void CategoryIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Category' with identifier '" + id + "'", net.triptech.metahive.model.Category.findCategory(id));
    }

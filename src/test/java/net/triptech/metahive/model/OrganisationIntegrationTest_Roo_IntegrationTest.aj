...
privileged aspect OrganisationIntegrationTest_Roo_IntegrationTest {
    ...
    public void OrganisationIntegrationTest.testCountOrganisations() {
        ...
        long count = net.triptech.metahive.model.Organisation.countOrganisations();
    ...
    public void OrganisationIntegrationTest.testFindOrganisation() {
        net.triptech.metahive.model.Organisation obj = dod.getRandomOrganisation();
        ...
        obj = net.triptech.metahive.model.Organisation.findOrganisation(id);
    ...
    public void OrganisationIntegrationTest.testFindAllOrganisations() {
        ...
        java.util.List<net.triptech.metahive.model.Organisation> result = net.triptech.metahive.model.Organisation.findAllOrganisations();
    ...
    public void OrganisationIntegrationTest.testFindOrganisationEntries() {
        ...
        java.util.List<net.triptech.metahive.model.Organisation> result = net.triptech.metahive.model.Organisation.findOrganisationEntries(0, (int) count);
    ...
    public void OrganisationIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyOrganisation(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        net.triptech.metahive.model.Organisation merged =  obj.merge();
        obj.flush();
    ...
    public void OrganisationIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Organisation' failed to initialize correctly", dod.getRandomOrganisation());
        net.triptech.metahive.model.Organisation obj = dod.getNewTransientOrganisation(Integer.MAX_VALUE);
    ...
    public void OrganisationIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Organisation' with identifier '" + id + "'", net.triptech.metahive.model.Organisation.findOrganisation(id));
    }

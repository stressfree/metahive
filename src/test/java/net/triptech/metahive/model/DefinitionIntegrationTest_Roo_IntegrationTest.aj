...
privileged aspect DefinitionIntegrationTest_Roo_IntegrationTest {
    ...
    public void DefinitionIntegrationTest.testCountDefinitions() {
        ...
        long count = net.triptech.metahive.model.Definition.countDefinitions();
    ...
    public void DefinitionIntegrationTest.testFindDefinition() {
        net.triptech.metahive.model.Definition obj = dod.getRandomDefinition();
        ...
        obj = net.triptech.metahive.model.Definition.findDefinition(id);
    ...
    public void DefinitionIntegrationTest.testFindAllDefinitions() {
        ...
        java.util.List<net.triptech.metahive.model.Definition> result = net.triptech.metahive.model.Definition.findAllDefinitions();
    ...
    public void DefinitionIntegrationTest.testFindDefinitionEntries() {
        ...
        java.util.List<net.triptech.metahive.model.Definition> result = net.triptech.metahive.model.Definition.findDefinitionEntries(0, (int) count);
    ...
    public void DefinitionIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyDefinition(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        net.triptech.metahive.model.Definition merged =  obj.merge();
        obj.flush();
    ...
    public void DefinitionIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Definition' failed to initialize correctly", dod.getRandomDefinition());
        net.triptech.metahive.model.Definition obj = dod.getNewTransientDefinition(Integer.MAX_VALUE);
    ...
    public void DefinitionIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Definition' with identifier '" + id + "'", net.triptech.metahive.model.Definition.findDefinition(id));
    }

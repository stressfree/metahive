...
privileged aspect CategoryIntegrationTest_Roo_IntegrationTest {
    ...
    public void CategoryIntegrationTest.testCountCategorys() {
        ...
        long count = com.sfs.metahive.model.Category.countCategorys();
    ...
    public void CategoryIntegrationTest.testFindCategory() {
        com.sfs.metahive.model.Category obj = dod.getRandomCategory();
        ...
        obj = com.sfs.metahive.model.Category.findCategory(id);
    ...
    public void CategoryIntegrationTest.testFindAllCategorys() {
        ...
        java.util.List<com.sfs.metahive.model.Category> result = com.sfs.metahive.model.Category.findAllCategorys();
    ...
    public void CategoryIntegrationTest.testFindCategoryEntries() {
        ...
        java.util.List<com.sfs.metahive.model.Category> result = com.sfs.metahive.model.Category.findCategoryEntries(0, (int) count);
    ...
    public void CategoryIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyCategory(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.sfs.metahive.model.Category merged = (com.sfs.metahive.model.Category) obj.merge();
        obj.flush();
    ...
    public void CategoryIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Category' failed to initialize correctly", dod.getRandomCategory());
        com.sfs.metahive.model.Category obj = dod.getNewTransientCategory(Integer.MAX_VALUE);
    ...
    public void CategoryIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Category' with identifier '" + id + "'", com.sfs.metahive.model.Category.findCategory(id));
    }

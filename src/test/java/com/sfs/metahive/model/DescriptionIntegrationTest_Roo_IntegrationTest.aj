...
import com.sfs.metahive.model.DescriptionDataOnDemand;
...
privileged aspect DescriptionIntegrationTest_Roo_IntegrationTest {
    ...
    public void DescriptionIntegrationTest.testCountDescriptions() {
        ...
        long count = com.sfs.metahive.model.Description.countDescriptions();
    ...
    public void DescriptionIntegrationTest.testFindDescription() {
        com.sfs.metahive.model.Description obj = dod.getRandomDescription();
        ...
        obj = com.sfs.metahive.model.Description.findDescription(id);
    ...
    public void DescriptionIntegrationTest.testFindAllDescriptions() {
        ...
        java.util.List<com.sfs.metahive.model.Description> result = com.sfs.metahive.model.Description.findAllDescriptions();
    ...
    public void DescriptionIntegrationTest.testFindDescriptionEntries() {
        ...
        java.util.List<com.sfs.metahive.model.Description> result = com.sfs.metahive.model.Description.findDescriptionEntries(0, (int) count);
    ...
    public void DescriptionIntegrationTest.testMerge() {
        ...
        boolean modified =  dod.modifyDescription(obj);
        java.lang.Integer currentVersion = obj.getVersion();
        com.sfs.metahive.model.Description merged = (com.sfs.metahive.model.Description) obj.merge();
        obj.flush();
    ...
    public void DescriptionIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Description' failed to initialize correctly", dod.getRandomDescription());
        com.sfs.metahive.model.Description obj = dod.getNewTransientDescription(Integer.MAX_VALUE);
    ...
    public void DescriptionIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Description' with identifier '" + id + "'", com.sfs.metahive.model.Description.findDescription(id));
    }

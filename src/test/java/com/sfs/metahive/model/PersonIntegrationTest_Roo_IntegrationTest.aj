...
privileged aspect PersonIntegrationTest_Roo_IntegrationTest {
    ...
    public void PersonIntegrationTest.testCountPeople() {
        ...
        long count = com.sfs.metahive.model.Person.countPeople();
    ...
    public void PersonIntegrationTest.testFindPerson() {
        com.sfs.metahive.model.Person obj = dod.getRandomPerson();
    ...
    public void PersonIntegrationTest.testFindAllPeople() {
        ...
        java.util.List<com.sfs.metahive.model.Person> result = com.sfs.metahive.model.Person.findAllPeople();
    ...
    public void PersonIntegrationTest.testFindPersonEntries() {
        ...
        java.util.List<com.sfs.metahive.model.Person> result = com.sfs.metahive.model.Person.findPersonEntries(0, (int) count);
    ...
    public void PersonIntegrationTest.testPersist() {
        org.junit.Assert.assertNotNull("Data on demand for 'Person' failed to initialize correctly", dod.getRandomPerson());
        com.sfs.metahive.model.Person obj = dod.getNewTransientPerson(Integer.MAX_VALUE);
    ...
    public void PersonIntegrationTest.testRemove() {
        ...
        obj.remove();
        obj.flush();
        org.junit.Assert.assertNull("Failed to remove 'Person' with identifier '" + id + "'", com.sfs.metahive.model.Person.findPerson(id));
    }

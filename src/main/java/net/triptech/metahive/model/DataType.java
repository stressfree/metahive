...
public enum DataType {
    ...
    TYPE_UNIQUEID("label_net_triptech_metahive_model_datatype_uniqueid"),
    TYPE_STRING("label_net_triptech_metahive_model_datatype_string"),
    TYPE_NUMBER("label_net_triptech_metahive_model_datatype_number"),
    TYPE_CURRENCY("label_net_triptech_metahive_model_datatype_currency"),
    TYPE_PERCENTAGE("label_net_triptech_metahive_model_datatype_percentage"),
    TYPE_BOOLEAN("label_net_triptech_metahive_model_datatype_boolean");

...
public enum UserRole {
    ...
    ROLE_ADMIN("label_net_triptech_metahive_model_userrole_admin"),
    ROLE_EDITOR("label_net_triptech_metahive_model_userrole_editor"),
    ROLE_CONTRIBUTOR("label_net_triptech_metahive_model_userrole_contributor"),
    ROLE_USER("label_net_triptech_metahive_model_userrole_user"),
    ANONYMOUS("label_net_triptech_metahive_model_userrole_anonymous");

...
import net.triptech.metahive.KeyValueIdentifier;
...
public enum KeyValueGenerator {
    ...
    NOT_APPLICABLE("label_net_triptech_metahive_model_keyvaluegenerator_not_applicable"),
    NEWEST("label_net_triptech_metahive_model_keyvaluegenerator_newest"),
    OLDEST("label_net_triptech_metahive_model_keyvaluegenerator_oldest"),
    FREQUENT_DEFAULT_NEW("label_net_triptech_metahive_model_keyvaluegenerator_frequent_new"),
    FREQUENT_DEFAULT_OLD("label_net_triptech_metahive_model_keyvaluegenerator_frequent_old"),
    CONCAT("label_net_triptech_metahive_model_keyvaluegenerator_concat"),
    UNCLEAR("label_net_triptech_metahive_model_keyvaluegenerator_unclear"),
    AVERAGE("label_net_triptech_metahive_model_keyvaluegenerator_average"),
    TOTAL("label_net_triptech_metahive_model_keyvaluegenerator_total"),
    HIGHEST("label_net_triptech_metahive_model_keyvaluegenerator_highest"),
    LOWEST("label_net_triptech_metahive_model_keyvaluegenerator_lowest"),
    MEDIAN("label_net_triptech_metahive_model_keyvaluegenerator_median"),
    QUARTILE_LOWER("label_net_triptech_metahive_model_keyvaluegenerator_quartile_lower"),
    QUARTILE_UPPER("label_net_triptech_metahive_model_keyvaluegenerator_quartile_upper");
